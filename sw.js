...
const PRECACHE_URLS = [
    ...
    'js/modules/exercises/shared.js',
    'js/modules/exercises/stages.js',
    'js/modules/exercises/render.js',
    'js/modules/exercises/builder.js',
    'js/modules/exercises/answer.js',
