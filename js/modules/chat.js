...
export const chat = {
    ...
    sendMessage: async () => {
        ...
        try {
            ...
            2. Если студент сделал грамматическую ошибку в последнем сообщении, мягко укажи на нее (можно кратко пояснить на русском) и напиши правильный вариант, прежде чем продолжить беседу.
            3. Если студент задает вопрос на русском, можешь ответить на русском, но обязательно приведи примеры на немецком.
