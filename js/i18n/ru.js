export const ru = {
    ...
    streak: {
        ...
        foundInLog: 'По журналу занятий видно {days} подряд с карточками. Счётчик отстал — его можно восстановить по журналу. Журнал знает, что вы занимались, но не знает, доводили ли урок до конца.',
        restore: 'ВОССТАНОВИТЬ',
        restored: 'Серия восстановлена: {days}.',
