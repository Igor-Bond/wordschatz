export const ru = {
    ...
    settings: {
        ...
        verdictOk: 'Страница доходит до нижнего края экрана. Если внизу всё равно светлая полоса — это системная панель устройства, приложение её не рисует.',
        verdictGap: 'Меню не достаёт до низа на {px} точек — это наша недоработка, сообщите.',
        verdictSystem: 'Браузер отдаёт приложению не весь экран: снизу занято {px} точек системной панелью. Полоса там рисуется устройством.',
        checking: 'Проверяем...',
