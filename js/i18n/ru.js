export const ru = {
    ...
    settings: {
        ...
        fullscreenHint: 'Прячет системные полосы снизу и сверху. Вместе с нижней полосой исчезают часы и заряд. Выйти можно жестом сверху вниз.',
        fullscreenDenied: 'Браузер не дал перейти в полноэкранный режим.',
        language: 'Язык интерфейса',
        langWarning: 'Интерфейс переключится, но уже сохранённые переводы останутся на прежнем языке — новые слова будут приходить на новом. Словарь окажется смешанным.',
        level: 'Уровень',
    ...
    reminder: {
        ...
        hint: 'Работает, пока приложение открыто или свёрнуто. Чтобы напоминание доходило и в закрытое, включите уведомление ниже.',
    ...
    push: {
        setting: 'Уведомление на закрытое приложение',
        hint: 'Присылается снаружи раз в сутки. На Android приходит и в закрытое приложение, на iPhone — если оно добавлено на домашний экран, на компьютере — пока запущен браузер.',
        enable: 'Включить',
        disable: 'Выключить',
        enabled: 'Включено',
        working: 'Подключаем…',
        unsupported: 'Браузер не умеет push-уведомления.',
        notConfigured: 'Push пока не настроен в этой сборке.',
        needSignIn: 'Нужен вход через Google: подписка хранится в вашем облаке.',
        denied: 'Уведомления запрещены. Разрешение выдаётся в настройках сайта.',
        blocked: 'Уведомления заблокированы в настройках браузера для этого сайта.',
        failed: 'Не удалось подписаться',
        check: 'ПРОВЕРИТЬ',
        copy: 'СКОПИРОВАТЬ',
        copied: 'Подписка в буфере обмена. Вставьте её в секрет PUSH_SUBSCRIPTIONS в настройках репозитория — и напоминания заработают.',
        copyManual: 'Буфер обмена недоступен. Выделите строку и скопируйте вручную:',
        checkOk: 'Подписка в облаке: {service}, обновлена {when}. Дальше дело за расписанием GitHub — смотрите журнал запуска.',
        noSubscription: 'Устройство не подписано.',
        notInCloud: 'Подписка есть на устройстве, но в облако не попала. Попробуйте выключить и включить заново.'
    },
    ...
    scanner: {
        ...
        photoPick: 'ВЫБРАТЬ ИЛИ СНЯТЬ',
        photoHint: 'Снимок уменьшается прямо здесь: на телефоне полноразмерное фото весит несколько мегабайт и запрос до ИИ не доходит.',
        photoReady: '{width}×{height}, {kb} КБ — готово к разбору',
        photoFailed: 'Не удалось прочитать изображение. Попробуйте другой файл.',
        photoNothing: 'На снимке не нашлось немецких слов.',
        loadingPhoto: 'ИИ разбирает снимок...',
        topicFromPhoto: 'Со снимка',
    ...
    profile: {
        ...
        xpMax: '{xp} XP (макс.)',
        allLeagues: 'Все лиги',
        leagueLadder: 'Лестница лиг',
        leagueReached: 'получена',
        leagueNow: 'сейчас',
        leagueNeed: 'ещё {xp} XP',
