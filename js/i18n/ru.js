export const ru = {
    ...
    settings: {
        ...
        screenCutOff: 'Окно короче экрана на {gap} точек — меню опущено на эту разницу программно. Насовсем это лечится переустановкой значка из Safari: iOS запоминает настройку строки состояния при установке, обновлением она не меняется.',
