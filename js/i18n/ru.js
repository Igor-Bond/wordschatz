export const ru = {
    ...
    goals: {
        5: '~ 10 мин в день (Лёгкий старт)',
        10: '~ 18 мин в день (Стандарт)',
        15: '~ 27 мин в день (Интенсив)',
    ...
    auth: {
        ...
        whereToFind: 'Включить можно в любой момент: «Профиль» в нижнем меню — кнопка «Войти через Google». Здесь этот шаг убран намеренно: вход уводит на страницу Google и возвращает обратно, а посреди первой настройки этот возврат срабатывает не на всех телефонах.',
