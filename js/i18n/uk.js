export const uk = {
    ...
    goals: {
        5: '~ 10 хв на день (Легкий старт)',
        10: '~ 18 хв на день (Стандарт)',
        15: '~ 27 хв на день (Інтенсив)',
    ...
    dashboard: {
        ...
        goalLowered: 'Норму нових слів знижено з {from} до {to} на день: повторення не вміщалися в урок три дні поспіль. Слів менше, зате вивчене не сиплеться. Підняти назад можна в налаштуваннях.',
    ...
    auth: {
        ...
        hint: 'Словник і поступ можна тримати в хмарі — тоді вони відкриються і на іншому телефоні, і на комп’ютері. Налаштовується це пізніше, у застосунку.',
        whereToFind: 'Увімкнути можна будь-коли: «Профіль» у нижньому меню — кнопка «Увійти через Google». Тут цей крок прибрано навмисно: вхід веде на сторінку Google і повертає назад, а посеред першого налаштування це повернення спрацьовує не на всіх телефонах.',
        worksOffline: 'Без входу застосунок працює повністю: словник, уроки й поступ зберігаються на пристрої. Хмара потрібна лише щоб відкрити їх ще й на іншому телефоні чи комп’ютері.',
    ...
    exercises: {
        ...
        builderRetry: 'Порядок не той — приберіть зайві слова й складіть заново.',
        builderFromTry: 'Складено з {n}-ї спроби · +{xp} XP',
