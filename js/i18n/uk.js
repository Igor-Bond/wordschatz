export const uk = {
    ...
    settings: {
        ...
        screenCutOff: 'Вікно коротше за екран на {gap} точок — меню опущено на цю різницю програмно. Остаточно це лікується перевстановленням значка з Safari: iOS запам’ятовує налаштування рядка стану під час встановлення, оновленням воно не змінюється.',
