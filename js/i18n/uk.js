export const uk = {
    ...
    settings: {
        ...
        fullscreenHint: 'Ховає системні смуги знизу і зверху. Разом із нижньою смугою зникають годинник і заряд. Вийти можна жестом згори вниз.',
        fullscreenDenied: 'Браузер не дав перейти в повноекранний режим.',
        language: 'Мова інтерфейсу',
        langWarning: 'Інтерфейс перемкнеться, але вже збережені переклади залишаться попередньою мовою — нові слова приходитимуть новою. Словник виявиться змішаним.',
        level: 'Рівень',
    ...
    push: {
        ...
        check: 'ПЕРЕВІРИТИ',
        copy: 'СКОПІЮВАТИ',
        copied: 'Підписка в буфері обміну. Вставте її в секрет PUSH_SUBSCRIPTIONS у налаштуваннях репозиторію — і нагадування запрацюють.',
        copyManual: 'Буфер обміну недоступний. Виділіть рядок і скопіюйте вручну:',
        checkOk: 'Підписка в хмарі: {service}, оновлена {when}. Далі справа за розкладом GitHub — дивіться журнал запуску.',
        noSubscription: 'Пристрій не підписано.',
        notInCloud: 'Підписка є на пристрої, але до хмари не потрапила. Спробуйте вимкнути та увімкнути знову.'
    },
