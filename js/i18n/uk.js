export const uk = {
    ...
    settings: {
        ...
        verdictOk: 'Сторінка доходить до нижнього краю екрана. Якщо внизу все одно світла смуга — це системна панель пристрою, застосунок її не малює.',
        verdictGap: 'Меню не дістає до низу на {px} точок — це наша хиба, повідомте.',
        verdictSystem: 'Браузер віддає застосунку не весь екран: знизу зайнято {px} точок системною панеллю. Смуга там малюється пристроєм.',
